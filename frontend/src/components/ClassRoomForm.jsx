  ...
  return (
    <div className="main-container">
      ...
      <form className="form-container" onSubmit={handleSubmit}>
        <div className="field">
          ...
          <div className="input-field">
            ...
            >
              ...
              <option value="Alfabetizare Digitală">
                Alfabetizare Digitală
              </option>
              <option value="Introducere în Programare">Intro. Coding</option>
              <option value="M1 - Introducere în Programare">
                M1 - Introducere în Programare
              </option>
              <option value="M2 - Avansarea în programare (Delightex) ">
                M2 - Avansarea în programare (Delightex){" "}
              </option>
              <option value="M3 - Programare VR/AR (Delightex)">
                M3 - Programare VR/AR (Delightex)
              </option>
              <option value="M4 - Programare Python în Delightex">
                M4 - Programare Python în Delightex
              </option>
              <option value="M5 - Introducere în Minecraft Education">
                M5 - Introducere în Minecraft Education
              </option>
              <option value="M6 - Avansare în Minecraft Education">
                M6 - Avansare în Minecraft Education
              </option>
              <option value="M7 - Introducere În Roblox LUA">
                M7 - Introducere În Roblox LUA
              </option>
        ...
        <div className="field">
          <p className="label">Class Subject</p>
        ...
        <div className="field">
          <p className="label">Class Type</p>
