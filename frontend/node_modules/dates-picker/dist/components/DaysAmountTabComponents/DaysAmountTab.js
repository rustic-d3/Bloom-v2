...
export function DaysAmountTab(props) {
  ...
  const defaultRanges = getDefaultRanges(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate());
  ...
  function updateOnChange(daysAmount) {
    if (daysAmount && daysAmount[0] !== "-" || daysAmount[0] === "-" && !isNaN(daysAmount[daysAmount.length - 1])) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "days-amount-tab-template"
  }, /*#__PURE__*/React.createElement("div", {
    className: "days-amount-tab-div",
    style: style
  }, defaultRanges.map((range, i) => {
    return /*#__PURE__*/React.createElement(DefaultRange, {
      key: i,
      range: range,
      index: i,
      boardsNum: boardsNum,
