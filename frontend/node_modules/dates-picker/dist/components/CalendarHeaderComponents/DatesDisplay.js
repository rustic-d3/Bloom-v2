...
export default function DatesDisplay(props) {
  ...
  }, [selectedDays, storedDates, chosenDatesList, chosenDates, setStoredDates, setChosenDatesList]);
  return /*#__PURE__*/React.createElement("div", {
    className: dateDisplayClassName,
    onMouseEnter: toggleHover,
    onMouseLeave: toggleHover,
    lang: language
  }, pickMethod !== "ranges" && chosenDates, pickMethod === "ranges" && !isCurrentlyHovered && (chosenDatesList.length === 0 ? /*#__PURE__*/React.createElement(ChosenDatesItem, {
  ...
  }) : /*#__PURE__*/React.createElement(ChosenDatesItem, {
    selectedColor: selectedColor,
    setSelectedDays: setSelectedDays,
    datesHeaderStateDispatch: datesHeaderStateDispatch,
    storedDates: storedDates,
    ...
    isDatesDisplayHovered: isCurrentlyHovered
  })), pickMethod === "ranges" && isCurrentlyHovered && /*#__PURE__*/React.createElement("div", {
    className: "hoverable-chosen-dates",
    style: selectedDaysStyle
  }, chosenDatesList.map((listItem, i) => {
    return /*#__PURE__*/React.createElement(ChosenDatesItem, {
      selectedColor: selectedColor,
      setSelectedDays: setSelectedDays,
      datesHeaderStateDispatch: datesHeaderStateDispatch,
      storedDates: storedDates,
