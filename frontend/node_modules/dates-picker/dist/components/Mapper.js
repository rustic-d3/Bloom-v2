...
export const Mapper = props => {
  ...
  const datesHeaderInitialState = datesHeaderInitialStateCalculation(language, boardsNum);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, showCalendar && /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(BoardInstance, {
      selectedColor: selectedColor,
  ...
  }), /*#__PURE__*/React.createElement(DaysAmountTabButton, {
    selectedColor: selectedColor,
    datesHeaderStateDispatch: datesHeaderStateDispatch,
    setSelectedDays: setSelectedDays,
    boardsNum: boardsNum
