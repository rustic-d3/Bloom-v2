...
export const LowerFooter = props => {
  ...
  if (language === "Hebrew" && (!(showPickButton && selectAllButton === "disabled") || colorPalette === "enabled" && boardsNum === 1) || id === 1 && selectAllButton === "disabled") {
    lowerFooterStyle = {
  ...
  const handlePickClick = () => {
    ...
    if (pickMethod === "ranges" && storedDates.length > 0) {
      ...
      const dates = chosenDatesCalculation([minDate, maxDate], null, format, pickMethod, language);
      ...
      const dates = chosenDatesCalculation(selectedDays, null, format, pickMethod, language);
      setButtonDatesText(dates);
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(ColorPickerPalette, {
    selectedColor: selectedColor,
    setSelectedColor: setSelectedColor,
    showPaletteAllowed: showPaletteAllowed,
    id: id,
    boardsNum: boardsNum
  }), /*#__PURE__*/React.createElement(SelectAllButton, {
    ...
    id: id,
    language: language
  }), showPickButton && /*#__PURE__*/React.createElement("button", {
