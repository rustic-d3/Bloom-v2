...
from api.views import ChildUpdateview, CreateUserView, ParentUpdateview, TokenObtainPairView, ListUserView, TeacherListView, ParentListView, CreateChildView, Childview
