...
from api.views import ChildDeleteview, ChildUpdateview, CreateUserView, ParentDeleteview, ParentUpdateview, TeacherDeleteview, TeacherObtainView, TeacherUpdateview, TokenObtainPairView, ListUserView, TeacherListView, ParentListView, CreateChildView, Childview
